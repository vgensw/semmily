import {Component, OnInit, OnDestroy, ViewChild, HostListener, ViewEncapsulation, Input}      from '@angular/core';
...
export class MainComponent implements OnInit, OnDestroy{
	...
	constructor(public menuItems: MenuItems, private breadcrumbService: BreadcrumbService, private pageTitleService: PageTitleService, public translate: TranslateService, private router: Router, private media: ObservableMedia, private mainService: MainService, private settingsService: SettingsService) {
        ...
        breadcrumbService.addFriendlyNameForRoute('/pages/userlist', 'User List');
